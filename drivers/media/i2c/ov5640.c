...
/*
 * OV5640 CMOS Image Sensor driver
 *
...
//MIPI_2lane_5M(YUV) 15fps
	...
	//auto night mode for 60/50Hz light environment, 24Mhz clock input,24Mzh pclk
	{0x3a00, 0x7c},
...
//	{0x4837, 0x44},
	...
	// ~ 10fps
	{0x3a02, 0x0b}, //60HZ max exposure limit MSB
	{0x3a03, 0x88}, //60HZ max exposure limit LSB
	{0x3a14, 0x0b}, //50HZ max exposure limit MSB
	{0x3a15, 0x88}, //50HZ max exposure limit LSB


	{REG_NULL, 0x00},
};

static const struct sensor_register ov5640_mipi_720P_30fps[] = {
//MIPI_2lane_720P(YUV) 60fps
	...
	//{0x3a0e, 0x03},//for 30fps
	//{0x3a0d, 0x04},
	{0x3a0e, 0x01},//for 60fps
	{0x3a0d, 0x02},
	...
	// ~ 10fps
	{0x3a02, 0x11}, //60HZ max exposure limit MSB
	{0x3a03, 0x58}, //60HZ max exposure limit LSB
	{0x3a14, 0x11}, //50HZ max exposure limit MSB
	{0x3a15, 0x58}, //50HZ max exposure limit LSB

	{REG_NULL, 0x00},
};

static const struct sensor_register ov5640_mipi_1080P_20fps[] = {
	{0x3035, 0x21},
	{0x3036, 0x54},
...
//	{0x3a0d, 0x08},
	...
	// ~ 10fps
	{0x3a02, 0x0b}, //60HZ max exposure limit MSB
	{0x3a03, 0x90}, //60HZ max exposure limit LSB
	{0x3a14, 0x0b}, //50HZ max exposure limit MSB
	{0x3a15, 0x90}, //50HZ max exposure limit LSB
...
#if 1
		if (ret < 0)
			printk("\n*** [__ov5640_power_on] Failed to set xvclk rate (24MHz)\n");
		else
			printk("\n*** [__ov5640_power_on] Success to set xvclk rate (24MHz)\n");
#else
		if (ret < 0)
